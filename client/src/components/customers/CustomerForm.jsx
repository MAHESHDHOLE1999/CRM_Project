...
//     queryFn: () => customerService.getById(customer._id),
...
//         setValue(
//           "checkInDate",
//           fetchedCustomer.checkInDate
//             ? new Date(fetchedCustomer.checkInDate)
//                 .toISOString()
//                 .split("T")[0]
//             : ""
//         );
...
//         setValue(
//           "checkOutDate",
//           fetchedCustomer.checkOutDate
//             ? new Date(fetchedCustomer.checkOutDate)
//                 .toISOString()
//                 .split("T")[0]
//             : ""
//         );
...
//         setSelectedItems(fetchedCustomer.items || []);
//       }
//     },
//     onError: (error) => {
...
//   }, [itemsTotal, watch("transportCost"), watch("maintenanceCharges"), setValue]);
...
//       console.log(
//         customer?._id ? `🔄 UPDATING customer: ${customer._id}` : "🆕 CREATING new customer"
//       );
...
//       toast.error("⚠️ Please fill in all date and time fields first");
//       return;
//     }
...
//       toast.success("✅ Default checkout set to next day at 10:00 AM");
//     } else {
//       toast.error("⚠️ Please select check-in date first");
//     }
//   };
...
//             <div>
//               <Label className={Object.keys(errors).includes("name") ? "text-red-600 font-semibold" : ""}>
//                 {t("customer.name")} *
//               </Label>
//               <Input
//                 {...register("name")}
...
//             <div>
//               <Label
//                 className={Object.keys(errors).includes("phone") ? "text-red-600 font-semibold" : ""}
//               >
//                 {t("customer.phone")} *
//               </Label>
//               <Input
...
//             <div>
//               <Label
//                 className={Object.keys(errors).includes("checkInDate") ? "text-red-600 font-semibold" : ""}
//               >
...
//             <div>
//               <Label
//                 className={Object.keys(errors).includes("checkInTime") ? "text-red-600 font-semibold" : ""}
//               >
...
//                           ₹{(customer?.extraCharges || 0).toLocaleString(
//                             "en-IN"
//                           )}
//                         </p>
//                       </div>
...
//             <div>
//               <Label
//                 className={Object.keys(errors).includes("status") ? "text-red-600 font-semibold" : ""}
//               >
//                 {t("customer.status")} *
//               </Label>
//               <Select
